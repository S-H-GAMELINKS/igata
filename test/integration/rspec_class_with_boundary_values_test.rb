...
class Igata
  class RSpecClassWithBoundaryValuesTest < Minitest::Test
    # rubocop:disable Metrics/MethodLength
    def test_generate_class_with_boundary_values
      source = File.read(File.expand_path("../fixtures/integration/minitest/sources/class_with_boundary_values.rb",
                                          __dir__))
    ...
    def test_generate_numeric_boundary_values
      source = File.read(File.expand_path("../fixtures/integration/minitest/sources/class_with_boundary_values.rb",
                                          __dir__))
      igata = Igata.new(source, formatter: :rspec)
      output = igata.generate
    ...
    def test_generate_string_boundary_values
      source = File.read(File.expand_path("../fixtures/integration/minitest/sources/class_with_boundary_values.rb",
                                          __dir__))
      igata = Igata.new(source, formatter: :rspec)
      output = igata.generate
    ...
    def test_generate_nil_boundary_values
      source = File.read(File.expand_path("../fixtures/integration/minitest/sources/class_with_boundary_values.rb",
                                          __dir__))
      igata = Igata.new(source, formatter: :rspec)
      output = igata.generate
    ...
    def test_generate_boolean_boundary_values
      source = File.read(File.expand_path("../fixtures/integration/minitest/sources/class_with_boundary_values.rb",
                                          __dir__))
      igata = Igata.new(source, formatter: :rspec)
      output = igata.generate
    ...
    def test_generate_symbol_boundary_values
      source = File.read(File.expand_path("../fixtures/integration/minitest/sources/class_with_boundary_values.rb",
                                          __dir__))
      igata = Igata.new(source, formatter: :rspec)
      output = igata.generate
    ...
    def test_method_without_boundary_values
      source = File.read(File.expand_path("../fixtures/integration/minitest/sources/class_with_boundary_values.rb",
                                          __dir__))
      igata = Igata.new(source, formatter: :rspec)
      output = igata.generate
